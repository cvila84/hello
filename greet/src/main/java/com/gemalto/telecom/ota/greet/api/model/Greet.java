...
public class Greet {
    ...
    public Greet(final String id, final String name, final String state, final Map<String, String> properties) {
        this.id = id;
        this.name = name;
        this.state = state;
    ...
    public boolean equals(Object o) {
        ...
        return id.equals(greet.id) &&
                name.equals(greet.name) &&
                Objects.equals(state, greet.state) &&
                Objects.equals(properties, greet.properties) &&
                Objects.equals(creationDate, greet.creationDate) &&
                Objects.equals(updateDate, greet.updateDate);
    }
